...
-- 
-- ---
CREATE DATABASE `bpmspace_liam2_v2` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `liam2_User` (
  ...
  `liam2_User_salt` MEDIUMTEXT NULL DEFAULT NULL,
...
CREATE TABLE `liam2_User_email` (
  `liam2_User_email_id` BIGINT(20) NULL AUTO_INCREMENT DEFAULT NULL,
  `liam2_User_id_fk_164887` BIGINT(20) NOT NULL,
  `liam2_email_id_fk_396224` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `liam2_email` (
  `liam2_email_id` INTEGER NULL AUTO_INCREMENT DEFAULT NULL,
  `liam2_email_text` VARCHAR(254 ) NULL DEFAULT NULL,
...
ALTER TABLE `liam2_User_email` ADD FOREIGN KEY (liam2_User_id_fk_164887) REFERENCES `liam2_User` (`liam2_User_id`);
ALTER TABLE `liam2_User_email` ADD FOREIGN KEY (liam2_email_id_fk_396224) REFERENCES `liam2_email` (`liam2_email_id`);
...
-- ALTER TABLE `liam2_User_email` ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
-- ALTER TABLE `liam2_email` ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- ('','','');
-- INSERT INTO `liam2_User_email` (`liam2_User_email_id`,`liam2_User_id_fk_164887`,`liam2_email_id_fk_396224`) VALUES
-- ('','','');
-- INSERT INTO `liam2_email` (`liam2_email_id`,`liam2_email_text`) VALUES
-- ('','');